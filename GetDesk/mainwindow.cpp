...
QString ScreenCap::GetVersion(void)
{
...
void ScreenCap::PrintInfoToFile(QString str)
{
...
//断开连接
void ScreenCap::disconnectSocket()
{
    timer->stop();
